GO_BIN_FILES=import-sh-json.go
GO_BIN_CMDS=import-sh-json
...
BINARIES=import-sh-json
STRIP=strip

all: check ${BINARIES}

import-sh-json: import-sh-json.go
	 ${GO_ENV} ${GO_BUILD} -o import-sh-json import-sh-json.go
